...
function Testimonial() {
  ...
  return (
    <div className="splide mt-10 bg-[#FAFAFA] pb-16">
      <div className='text-center pb-10'>
        <p className='font-montserrat font-medium text-[#5A67A7] lg:pb-8 pb-6'>TESTIMONALS</p>
        <p className='font-redhat font-bold text-[#18181B] lg:text-4xl pb-6'>Hear What Our Clients Say</p>
        <p className='font-poppins font-normal text-[#12141D99] lg:w-[483px] lg:h-[48px] mx-auto'>Discover the experiences of businesses like yours who have benefited from our services.</p>
      </div>
        ...
        <ul className="splide__list">
          <li className="splide__slide w-[330px] px-4 md:px-0 md:w-[390px] h-[350px] flex flex-col justify-center items-center gap-4 bg-white">
            ...
            <div className='flex flex-col justify-center items-center'>
              <h1 className='text-[#383838] font-bold font-montserrat' >Ashlynn</h1>
          ...
          <li className="splide__slide w-[330px] px-4 md:px-0 md:w-[390px] h-[350px] flex flex-col justify-center items-center gap-4 bg-white">
            ...
            <p>⭐⭐⭐⭐⭐</p>
            <div className='flex flex-col justify-center items-center'>
              <h1 className='text-[#383838] font-bold font-montserrat' >Miracle</h1>
              <p className='text-[#383838] font-poppins'>Professor</p>
            </div>
